...
Module ValidationModule
    ...
    Public Function ValidasiPembayaran(ep As ErrorProvider,
                                       txtIdBayar As TextBox,
                                       cboNIS As ComboBox,
                                       txtJumlahBayar As TextBox,
                                       cboBulan As ComboBox,
                                       cboStatus As ComboBox) As Boolean

        Dim idValid As Boolean = ValidasiTextBox(ep, txtIdBayar, "ID Bayar tidak boleh kosong")
        Dim nisValid As Boolean = ValidasiComboBox(ep, cboNIS, "NIS harus dipilih")
        Dim jumlahValid As Boolean = ValidasiTextBox(ep, txtJumlahBayar, "Jumlah bayar tidak boleh kosong")
        Dim bulanValid As Boolean = ValidasiComboBox(ep, cboBulan, "Bulan harus dipilih")
        Dim statusValid As Boolean = ValidasiComboBox(ep, cboStatus, "Status bayar harus dipilih")

        Return idValid And nisValid And jumlahValid And bulanValid And statusValid
    End Function
