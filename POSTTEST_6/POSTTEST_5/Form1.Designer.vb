...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' btnPembayaran
        ' 
        btnPembayaran.BackColor = Color.Cyan
        btnPembayaran.ForeColor = SystemColors.ActiveCaptionText
        btnPembayaran.Location = New Point(406, 489)
        btnPembayaran.Name = "btnPembayaran"
        btnPembayaran.Size = New Size(155, 29)
        btnPembayaran.TabIndex = 24
